	...
	<tbody>
		...
		<tr>
			<td colspan="6" class="actions">
				...
				<input type="button" class="button" id="popup-box-send-email-cart-items-btn" name="popup-box-send-email-cart-items" value="<?php esc_attr_e( 'lijst per email sturen', 'woocommerce' ); ?>" />
