...
$woo_framework_url = get_template_directory_uri() . '/function/';
...
<div id="woo-options-error">
	...
	<p><?php echo sprintf( __( 'The framework is a collection of functionality that all WooThemes have in common. In most cases you can update the framework even if you have modified your theme, because the framework resides in a separate location (under %s).', 'woothemes' ), '<code>/function/</code>' ); ?></p>
