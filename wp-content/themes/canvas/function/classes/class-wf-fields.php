...
class WF_Fields {
	...
	protected function render_field_upload ( $key, $args ) {
		...
		$placeholder = apply_filters( 'wf_placeholder_image_url', get_template_directory_uri() . '/function/assets/images/placeholder.png' );
		$class = ' no-image';
	 ...
	 */
	public function init_sections ( $data = array() ) {
		if ( 0 >= count( $data ) ) return new WP_Error( 'bad_settings_data', __( 'The settings data provided is malformed. Please try again.', 'woothemes' ) );
	 ...
	 */
	public function init_fields ( $data = array() ) {
		if ( 0 >= count( $data ) ) return new WP_Error( 'bad_settings_data', __( 'The settings data provided is malformed. Please try again.', 'woothemes' ) );
