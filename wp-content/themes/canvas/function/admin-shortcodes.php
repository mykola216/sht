...
if ( ! function_exists( 'woo_shortcode_stylesheet' ) && 'true' != get_option( 'framework_woo_disable_shortcodes', 'false' ) ) {
	function woo_shortcode_stylesheet() {
		echo "\n" . "<!-- Woo Shortcodes CSS -->\n";
		echo '<link href="'. get_template_directory_uri() . '/function/css/shortcodes.css" rel="stylesheet" type="text/css" />'."\n";
...
function woo_register_shortcode_js () {
	wp_register_script( 'woo-shortcodes', get_template_directory_uri() . '/function/js/shortcodes.js', array( 'jquery', 'jquery-ui-tabs' ), '5.0.0' );
