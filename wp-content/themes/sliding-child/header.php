...
<script type="text/javascript">stLight.options({publisher: "c4c40d90-2189-4fa7-8b1c-192a6f2fe24f", doNotHash: false, doNotCopy: false, hashAddressBar: false});</script>
</head>
...
<div id="wrapper">
    ...
    <header id="header" class="col-full">
        ...
        <?php
            if($options['show_usps_sidebar']=='on') {
                echo '<div id="usps">';
                    dynamic_sidebar( 'usps' );
                echo '</div>';
            } else {
                dynamic_sidebar( 'banner-sliding-child' );
            }
        ?>
    ...
    <nav id="navigation" class="col-full" role="navigation">
        ...
        <!-- https://crm.smart-gamma.com/issues/5 -->
    ...
    <div id="working-time" class="col-full">
        <?php
            // dynamic_sidebar('working_time_widget_area');
            $options = get_option('sliding_child_options');
            echo $options['working_time'];
        ?>
    </div>