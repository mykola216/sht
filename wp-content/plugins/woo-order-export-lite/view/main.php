...
<h2 class="nav-tab-wrapper" id="tabs">
	...
	<a class="nav-tab <?php echo $active_tab == 'order_actions' ? 'nav-tab-active' : '' ?>" href="<?php echo admin_url( 'admin.php?page=wc-order-export&tab=order_actions' ) ?>"><?php _e( 'Status Change', 'woocommerce-order-export' ) ?></a>
