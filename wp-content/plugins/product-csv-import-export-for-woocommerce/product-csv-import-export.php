...
if ( ! class_exists( 'WF_Product_Review_Import_Export_CSV' ) ) :
    ...
    add_action('admin_head', 'xa_impexp_welcome_screen_remove_menus');
    register_activation_hook(__FILE__, 'hf_welcome_screen_and_activation_check');
	...
	if( !function_exists('xa_impexp_welcome_screen_remove_menus') ){
