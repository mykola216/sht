<div class="tool-box">
    <h3 class="title"><?php _e('Import Product Reviews in CSV Format:', 'wf_csv_import_export'); ?></h3>
    ...
    <p class="submit">
        ...
        ?>
        <a class="button button-primary" id="mylink" href="<?php echo admin_url('admin.php?import=product_reviews_csv'); ?>"><?php _e('Import Product Reviews', 'wf_csv_import_export'); ?></a>
        &nbsp;
