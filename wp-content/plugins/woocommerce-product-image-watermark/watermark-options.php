...
<div class="wrap woocommerce">
    ...
    <form method="post" action="">
        ...
        <p>
            ...
            <?php
            /*if(!isset($_SESSION['regeneratethumbnailcount'])){
                $_SESSION['regeneratethumbnailcount'] = 0;
            }
            echo "Please re-generate the thumbnails ".(3-$_SESSION['regeneratethumbnailcount'])." more times so that watermarks are applied correctly to all thumbnails.";*/
            ?>
        </p>
    </form>
</div>
