<h2 class="nav-tab-wrapper woo-nav-tab-wrapper">
    ...
    <a href="admin.php?page=followup-emails-settings&amp;tab=integration" class="nav-tab <?php if ($tab == 'integration') echo 'nav-tab-active'; ?>"><?php _e(' Optional Extras', 'follow_up_emails'); ?></a>
