<div class="options_group">
    <?php if ( $email->type == 'storewide' ): ?>
        <p class="form-field">
            ...
            <span class="description"><?php _e('Always send this email, regardless of other initial rules. Use carefully, as this could result in multiple emails being sent per order.', 'follow_up_emails'); ?></span>
        </p>
    <?php else: ?>
    ...
    <?php if ( ! in_array( $email->type, array( 'signup', 'manual' ) ) ): ?>
        <p class="form-field">
            ...
            <span class="description"><?php _e('A customer will only receive this email once, even if purchased multiple times at different dates', 'follow_up_emails'); ?></span>
        </p>
        ...
        <p class="form-field">
            ...
            <span class="description"><?php _e('If the customer already has this email scheduled, it will delay that scheduled email to the new future date.', 'follow_up_emails'); ?></span>
        </p>
    <?php endif; ?>
    ...
    <?php if ( 'twitter' === $email->type ): ?>
        <p class="form-field">
            <label for="require_twitter_handle">
                <?php _e( 'Require twitter handle', 'follow_up_emails'); ?>
            </label>
            ...
            <span class="description"><?php _e( 'Only tweet when a customer has twitter handle.', 'follow_up_emails' ); ?></span>
        </p>
    <?php endif; ?>
</div><!-- /options_group -->
