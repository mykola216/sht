...
class Store_Apps_Upgrade_1_2 {
    ...
    function validate_license_key() {
        ...
        $storeapps_validation_url = 'http://www.storeapps.org/?wc-api=validate_serial_key&serial=' . urlencode( $this->license_key ) . '&is_download=true&sku=' . $this->sku . '&uuid=' . admin_url();
            ...
            jQuery( document ).ready(function() {
                try {
                    ...
                    var icegram_get_messages = function(){
                        ...
                        var admin_ajax = "http://www.storeapps.org/wp-admin/admin-ajax.php";
                        jQuery.ajax({
                            url: admin_ajax,
                            type: "POST",
                            data : params,
